<CFIF findnocase('cranemountain',#CGI.SERVER_NAME#)>
	<CFLOCATION URL="./cm/">
<CFELSEIF findnocase('wap',#CGI.SERVER_NAME#)>
	<CFLOCATION URL="./wap/">
<CFELSEIF findnocase('isittheweekend',#CGI.SERVER_NAME#)>
	<CFLOCATION URL="./iitw/">
<CFELSEIF findnocase('allaboutamy',#CGI.SERVER_NAME#)>
	<CFLOCATION URL="/aaa/">
<CFELSEIF findnocase('eve',#CGI.SERVER_NAME#)>
	<CFLOCATION URL="/greacen/eve/">
<CFELSEIF findnocase('photo',#CGI.SERVER_NAME#)>
	<CFLOCATION URL="/greacen/photo/">
<CFELSEIF findnocase('fruit',#CGI.SERVER_NAME#)>
	<CFLOCATION URL="/greacen/fruit/">
<CFELSEIF findnocase('greacen',#CGI.SERVER_NAME#)>
	<CFLOCATION URL="http://greacen.com/greacen/">
<CFELSEIF findnocase('amy',#CGI.SERVER_NAME#)>
	<CFLOCATION URL="/greacen/amy/">
<CFELSEIF findnocase('song',#CGI.SERVER_NAME#)>
	<CFLOCATION URL="/songs/">
<CFELSEIF findnocase('29',#CGI.SERVER_NAME#)>
	<CFLOCATION URL="/29/">
<CFELSEIF findnocase('52',#CGI.SERVER_NAME#)>
	<CFLOCATION URL="/52/">
<CFELSEIF findnocase('manatee',#CGI.SERVER_NAME#)>
	<CFLOCATION URL="/media/rokkkk/">
<CFELSEIF findnocase('video',#CGI.SERVER_NAME#)>
	<CFLOCATION URL="/video/">
<CFELSEIF findnocase('zupercomputer',#CGI.SERVER_NAME#)>
	<CFLOCATION URL="/zupercomputer/">
<CFELSEIF findnocase('www.adreel',#CGI.SERVER_NAME#)>
	<CFLOCATION URL="/comingsoon">
<CFELSEIF findnocase('adreel',#CGI.SERVER_NAME#)>
	<CFLOCATION URL="http://beta.adreel.tv">
<CFELSE>
	<CFIF #CGI.HTTP_REFERER# IS NOT "" AND mid("#CGI.HTTP_REFERER#", 8, 8) IS NOT "netscrap" AND mid("#CGI.HTTP_REFERER#", 12, 8) IS NOT "netscrap" AND #CGI.SERVER_NAME# IS NOT "localhost">
		...
		<cffile action="APPEND" file="D:\FTP\chrisg2003\Htdocs\admin\netscrap_referer.log" output="%%#DateFormat(Now(), 'mm-dd-yy')#%%,%%/default.cfm%%,%%#CGI.HTTP_REFERER#%%,%%#email_id#%%">
		...
		<CFIF CGI.HTTP_REFERER IS NOT "">
			...
			<cffile action="APPEND" file="D:\FTP\chrisg2003\Htdocs\admin\netscrap_referer.log" output="%%#DateFormat(Now(), 'mm-dd-yy')#%%,%%#CGI.HTTP_REFERER#%%,%%#email_id#%%">
			<cferror type="REQUEST" template="./netscrap.cfm" mailto="scrapmaster@netscrap.com">
		</CFIF>
		------------------------------>
